...
they like. The user can build their own actors- and behaivor-types if their
...
actors usually requires implementing two interfaces, first the trait of the desired
behavior to implement (defining how your actor behaves), as well as the
